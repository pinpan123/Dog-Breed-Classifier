...
def get_input_args():
    ...
    # Argument 1: Image Folder (path to the folder of pet images)
    parser.add_argument("--dir", type=str, default="pet_images/",
                        help="path to the folder of pet images")

    # Argument 2: CNN Model Architecture (default: 'vgg', choices: 'vgg', 'alexnet', 'resnet')
    parser.add_argument("--arch", type=str, default="vgg", choices=["vgg", "alexnet", "resnet"],
                        help="CNN Model Architecture")

    # Argument 3: Text File with Dog Names (default: 'dognames.txt')
